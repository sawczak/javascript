...
header.innerHTML = 'Nowy kontent w header'; // zamiast struktury html consola pokaże nam podany tekst
...
/* 
document.querySelector('header').lastElementChild.textContent = 'inny span!';
